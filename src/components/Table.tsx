  ...
  return (
    ...
    <div className="table">
        <div className="row">
          ...
          <div className="cell bold">{title==='Table 1' ? 'Flavanoids':'Gamma'} <br /> Mean</div>
          <div className="cell bold">{title==='Table 1' ? 'Flavanoids':'Gamma'} <br /> Median</div>
          <div className="cell bold">{title==='Table 1' ? 'Flavanoids':'Gamma'} <br /> Mode</div>
        </div>
        {
          data.length &&
          data.map((item:any) => (
